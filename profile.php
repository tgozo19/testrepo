...
<body class="header-dark">
							...
							<div class="profile-tab height-100-p">
								<div class="tab height-100-p">
									<ul class="nav nav-tabs customtab" role="tablist">
										<li class="nav-item">
											<a class="nav-link active" data-toggle="tab" href="#timeline" role="tab"> Classes </a>
										</li>
										<li class="nav-item">
											<a class="nav-link" data-toggle="tab" href="#tasks" role="tab"> Teachers </a>
										</li>
									</ul>
									<div class="tab-content">
										...
										<!-- Timeline Tab End schoolClasses -->
										<!-- Tasks Tab start -->
										<div class="tab-pane fade" id="tasks" role="tabpanel">
											<div class="pd-20 profile-task-wrap">
												<div id="schoolTeachers"></div>
											</div>
										</div>
										<!-- Tasks Tab End -->
									</div>
	...
	<script src="src/scripts/teachers.js"></script>
