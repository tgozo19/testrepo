		...
		<div class="pd-ltr-20 xs-pd-20-10">
            <div class="pd-20 card-box mb-30">
                <div class="clearfix mb-20">
                    <div class="pull-left">
                        <h4 class="text-blue h4"> End Term </h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4"></div>
                    <div class="col-md-4 col-sm-12 text-center">
                        <form id="endTermForm" method="POST" action="api/end-term.php" enctype="multipart/form-data">
							<div class="form-group">
                                <h6> Please select the date you want to end this term </h6>
                            </div>
                            <div class="form-group">
			...
			<button type="button" class="btn mb-20 btn-primary btn-block d-none" id="custom-padding-width-alert"></button>
				...
				<div class="modal-dialog modal-sm modal-dialog-centered">
					<div class="modal-content bg-danger text-white">
						<div class="modal-body text-center">
							...
							<p>
								Failed to end Term. Please try again
							</p>
