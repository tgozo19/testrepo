		...
		<div class="pd-ltr-20 xs-pd-20-10">
            <div class="pd-20 card-box mb-30">
                <div class="clearfix mb-20">
                    <div class="pull-left">
                        <h4 class="text-blue h4"> Add Classes </h4>
                        <p> For example Form 1A, Form 1B, Lower 6 Sciences </p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4"></div>
                    <div class="col-md-4 col-sm-12 text-center">
                        <form id="addClassForm" method="POST" action="api/setclass/set-class.php" enctype="multipart/form-data">
                            <div class="form-group">
                                <label> Select Level </label>
                                <select id="addLevel" name="levelName" class="form-control" placeholder="Level Name" type="text">
                            ...
                            <div class="form-group">
                                ...
                                <select id="addTeacher" name="classTeacher" class="form-control" type="text">
		...
		<div class="modal-dialog modal-dialog-centered max-width-400" role="document">
			<div class="modal-content">
				<div class="modal-body text-center font-18">
					<h3 class="mb-20"> Class Added! </h3>
					<div class="mb-30 text-center"><img src="vendors/images/success.png"></div>
					    Do you want to add another class?
				</div>
				<div class="modal-footer justify-content-center">
					<a href="add-class.php" class="btn btn-primary">Yes</a>
